...
<head>
  <!-- Add this inside <head> of cregister.php -->
...
function getdistrict(val) {
  $.ajax({
    ...
    success: function(data){
      ...
      $("#city-list").html('<option value="">Select City</option>'); // reset city
    }
  });
}
...
<form name="insert" action="" method="post">	
    ...
    $("#success").slideUp(500);
			  ...
			  <!-- District Dropdown -->
<div class="form-group row">
    <label for="district" class="col-md-3 col-form-label text-white"> District <strong class="text-default"> *</strong></label>
    <div class="col-md-9">
...
<div class="form-group row">
    <label for="city" class="col-md-3 col-form-label text-white">
        City <strong class="text-default"> *</strong>
    </label>
    <div class="col-md-9">
