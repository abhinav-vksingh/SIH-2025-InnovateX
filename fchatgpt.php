...
<script>
    ...
    const apiKey = "AIzaSyDZqTyCn5O4iCH945xyHocSg9UJn8XNagE"; // Enter your apikey here
    ...
    sendButton.on("click", () => {
        ...
        if (message) {
            ...
            const displaytext = markdownit().render(message);
    ...
    function fetchMessages() {
        ...
        $.ajax(settings).done(function(response) {
            ...
            const htmlText = markdownit().render(geminiResponse);
